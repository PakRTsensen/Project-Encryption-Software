...
public class CipherProvider {
	...
	public static EAXBlockCipher getEAXCipher(boolean forEncryption, byte[] nonce, byte[] key, int algorithmCode, byte[] additionalData)
	{
	...
	public static BufferedBlockCipher getCTRCipherBuffered(boolean forEncryption, byte[] nonce, byte[] key, int algorithmCode)
	{
		return new BufferedBlockCipher(getCTRCipher(forEncryption, nonce, key, algorithmCode));
	}
