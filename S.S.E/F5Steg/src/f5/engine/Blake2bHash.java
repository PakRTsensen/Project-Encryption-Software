...
import static f5.engine.Blake2bHash.Engine.Assert.assertFail;
import static f5.engine.Blake2bHash.Engine.Assert.exclusiveLowerBound;
import static f5.engine.Blake2bHash.Engine.Assert.inclusiveLowerBound;
import static f5.engine.Blake2bHash.Engine.Assert.inclusiveUpperBound;
import static f5.engine.Blake2bHash.Engine.LittleEndian.readInt;
import static f5.engine.Blake2bHash.Engine.LittleEndian.readLong;
import static f5.engine.Blake2bHash.Engine.LittleEndian.writeInt;
import static f5.engine.Blake2bHash.Engine.LittleEndian.writeLong;
...
//			Debug.dumpArray("init H", this.h);
		...
		/** {@inheritDoc} */
		@Override final public void doFinal(byte[] output, int off, int len) {
		...
		/** {@inheritDoc} */
		@Override final public byte[] doFinal () throws IllegalArgumentException {
		...
		/** {@inheritDoc} */
		@Override final public byte[] doFinal (byte[] input) {
			update(input, 0, input.length);
			return doFinal();
		}
